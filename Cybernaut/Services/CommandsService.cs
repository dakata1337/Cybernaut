...
namespace Cybernaut.Services
{
    public class CommandsService
    {
        public async Task<Embed> GetInvite(SocketCommandContext context)
        {
            ...
            {
                return await EmbedHandler.CreateBasicEmbed("Invite Error", $"{context.Message.Author.Mention} i'm sorry but this bot is ether private\nor there is no invite link provided by the Bot Owner.", Color.Blue);
            }
